                ...
                <div className="space-y-8">
                  ...
                  <div className="flex gap-5 group">
                    ...
                    <div>
                      ...
                      <p className="text-secondary text-sm leading-relaxed mt-2">
                        One Architectural Plaza, Suite 400<br/>
                  ...
                  <div className="flex gap-5 group">
                    ...
                    <div>
                      ...
                      <p className="text-secondary text-lg mt-1 font-semibold">+1 (800) 555-0198</p>
                  ...
                  <div className="flex gap-5 group">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <a href="mailto:support@ctcsolutions.com" className="text-primary hover:underline text-sm font-semibold mt-1">support@ctcsolutions.com</a>
                    </div>
                  </div>
                </div>
              </section>
